...
Namespace DXApplication5
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' schedulerStorage
			' 
'			Me.schedulerStorage.AppointmentsChanged += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.Storage_AppointmentsChanged);
			' 
			' dateNavigator
			' 
			Me.dateNavigator.Dock = System.Windows.Forms.DockStyle.Right
			Me.dateNavigator.HotDate = Nothing
			Me.dateNavigator.Location = New System.Drawing.Point(910, 94)
			Me.dateNavigator.Name = "dateNavigator"
			Me.dateNavigator.SchedulerControl = Me.schedulerControl
			Me.dateNavigator.Size = New System.Drawing.Size(190, 606)
			...
			Me.schedulerControl.Size = New System.Drawing.Size(910, 606)
...
'			Me.schedulerControl.InplaceEditorShowing += New DevExpress.XtraScheduler.InplaceEditorEventHandler(Me.schedulerControl_InplaceEditorShowing);
			...
			Me.labelControl1.Text = "Select an appointment and press F2 to activate the inplace editor." & Constants.vbCrLf & Constants.vbCrLf & "Press CTRL-" & "S to commit changes and close the editor " & Constants.vbCrLf & "or " & Constants.vbCrLf & "press CTRL-Z to cancel changes a" & "nd close the editor."
			' 
			' panelControl1
			' 
